...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.button_a1_decrease = customtkinter.CTkButton(self.button_frame, text="-", width=50)
        self.button_a2_decrease = customtkinter.CTkButton(self.button_frame, text="-", width=50)
        self.button_a3_decrease = customtkinter.CTkButton(self.button_frame, text="-", width=50)
        self.button_a4_decrease = customtkinter.CTkButton(self.button_frame, text="-", width=50)
        self.button_a5_decrease = customtkinter.CTkButton(self.button_frame, text="-", width=50)
        self.button_a6_decrease = customtkinter.CTkButton(self.button_frame, text="-", width=50)
        ...
        self.button_a1_decrease.bind('<ButtonPress-1>', lambda event: self.control_motor("D", 0))
        self.button_a2_decrease.bind('<ButtonPress-1>', lambda event: self.control_motor("D", 1))
        self.button_a3_decrease.bind('<ButtonPress-1>', lambda event: self.control_motor("D", 2))
        self.button_a4_decrease.bind('<ButtonPress-1>', lambda event: self.control_motor("D", 3))
        self.button_a5_decrease.bind('<ButtonPress-1>', lambda event: self.control_motor("D", 4))
        self.button_a6_decrease.bind('<ButtonPress-1>', lambda event: self.control_motor("D", 5))
        
        self.button_a1_decrease.bind('<ButtonRelease-1>', lambda event: self.stop_motor(0))
        self.button_a2_decrease.bind('<ButtonRelease-1>', lambda event: self.stop_motor(1))
        self.button_a3_decrease.bind('<ButtonRelease-1>', lambda event: self.stop_motor(2))
        self.button_a4_decrease.bind('<ButtonRelease-1>', lambda event: self.stop_motor(3))
        self.button_a5_decrease.bind('<ButtonRelease-1>', lambda event: self.stop_motor(4))
        self.button_a6_decrease.bind('<ButtonRelease-1>', lambda event: self.stop_motor(5))

        
        
        self.button_a1_increase = customtkinter.CTkButton(self.button_frame, text="+", width=50)
        self.button_a2_increase = customtkinter.CTkButton(self.button_frame, text="+", width=50)
        self.button_a3_increase = customtkinter.CTkButton(self.button_frame, text="+", width=50)
        self.button_a4_increase = customtkinter.CTkButton(self.button_frame, text="+", width=50)
        self.button_a5_increase = customtkinter.CTkButton(self.button_frame, text="+", width=50)
        self.button_a6_increase = customtkinter.CTkButton(self.button_frame, text="+", width=50)
        ...
        self.button_a1_increase.bind('<ButtonPress-1>', lambda event: self.control_motor("I", 0))
        self.button_a2_increase.bind('<ButtonPress-1>', lambda event: self.control_motor("I", 1))
        self.button_a3_increase.bind('<ButtonPress-1>', lambda event: self.control_motor("I", 2))
        self.button_a4_increase.bind('<ButtonPress-1>', lambda event: self.control_motor("I", 3))
        self.button_a5_increase.bind('<ButtonPress-1>', lambda event: self.control_motor("I", 4))
        self.button_a6_increase.bind('<ButtonPress-1>', lambda event: self.control_motor("I", 5))
        
        self.button_a1_increase.bind('<ButtonRelease-1>', lambda event: self.stop_motor(0))
        self.button_a2_increase.bind('<ButtonRelease-1>', lambda event: self.stop_motor(1))
        self.button_a3_increase.bind('<ButtonRelease-1>', lambda event: self.stop_motor(2))
        self.button_a4_increase.bind('<ButtonRelease-1>', lambda event: self.stop_motor(3))
        self.button_a5_increase.bind('<ButtonRelease-1>', lambda event: self.stop_motor(4))
        self.button_a6_increase.bind('<ButtonRelease-1>', lambda event: self.stop_motor(5))
    ...
    def control_motor(self, direction, motor_index):
        if direction == "D":
            robot.send_string_over_serial("D", motor_index)
            robot.get_current_positions()
            self.update_thetas()
        if direction == "I":
            robot.send_string_over_serial("I", motor_index)
            robot.get_current_positions()
            self.update_thetas()
            
    def stop_motor(self, motor_index):
        robot.send_string_over_serial("B", motor_index)
    ...
    def update_thetas(self):
        ...
        # self.label_a4_theta.configure(text=robot.get_theta(3))
        # self.label_a5_theta.configure(text=robot.get_theta(4))
        # self.label_a6_theta.configure(text=robot.get_theta(5))
